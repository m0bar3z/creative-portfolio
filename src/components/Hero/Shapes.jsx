...
// ContactShadows: for shadows
// Enviroment: lighting setup
...
function Geometrics() {
  const geometrics = [
    ...
    },
    {
      position: [-1.4, 2, -4],
      r: 0.6,
      geometry: new THREE.DodecahedronGeometry(1.5), // pill
    },
    {
      position: [-0.8, -0.75, 5],
      r: 0.5,
  ...
  const soundEffects = [
    ...
    new Audio("/sounds/public_sounds_hit5.ogg"),
    new Audio("/sounds/public_sounds_hit6.ogg"),
    new Audio("/sounds/public_sounds_hit7.ogg"),
    new Audio("/sounds/public_sounds_hit8.ogg"),
  ];
